#ifndef __TEST_OPTIMIZED_MAPPER_H__
#define __TEST_OPTIMIZED_MAPPER_H__

#include"slam_base.h"

class OptimizedMapper : public SlamBase
{
public:
	OptimizedMapper(const Options& options)
	:SlamBase(options)
	{}
...
#endif // __TEST_OPTIMIZED_MAPPER_H__